...
public class JframeGroupe extends JFrame {
	...
	public JframeGroupe(List<Match> tour1, List<Match> tour2) { // top 4 si simple
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		...
		aTours.add(tour1);
		aTours.add(tour2);	
		drawTour(aTours.get(0), 50, 60, 5);
		drawTour(aTours.get(1), 260, 87, 60);

	}
	public JframeGroupe(List<Match> finale) { // finale si double
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
